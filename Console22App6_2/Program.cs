...
namespace Console22App6_2
{
    ...
    class Program
    {
        ...
        /// <param name="step">Шаг дискретизации</param>
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Задайте отрезок для нахождения минимума в формате 'х1 х2' (например 3 8):");

            double start = 0;
            double end = 0;
            GetInterval(out start, out end);

            Console.WriteLine("Задайте величину шага дискредитирования:");
